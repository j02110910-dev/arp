...
class E2eVerifier {
    ...
    async verify(claim) {
        ...
        if (applicableTests.length === 0) {
            return this.buildResult(claim.id, 'skipped', 100, 'No applicable E2E tests found for this claim', details, startTime);
        }
        // Run each test
        let passed = 0;
        let failed = 0;
            ...
            tests: [
                ...
                },
                {
                    ...
                    assert: (claim) => {
                        ...
                        if (typeof claim.output === 'object' && !Array.isArray(claim.output) && Object.keys(claim.output).length === 0) {
    ...
    buildResult(claimId, status, score, message, details, startTime, testOutput) {
        return {
            id: (0, uuid_1.v4)(),
            claimId,
...
exports.E2eVerifier = E2eVerifier;
//# sourceMappingURL=e2eVerifier.js.map